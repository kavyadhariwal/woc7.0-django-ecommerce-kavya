...
from Home.views import (
    ...
    category_products, add_to_cart, about, Home, submit_ratings, cart_count_view, wishlist_view, add_to_wishlist, remove_from_wishlist, add_to_cart, wishlist_count,add_to_cart_from_wishlist,order_summary
)
from django.conf import settings
from django.conf.urls.static import static

admin.site.site_header = "Pinkay Admin"
admin.site.site_title = "Your go to shopping app"
admin.site.site_index = "Welcome to Pinkay Portal"
